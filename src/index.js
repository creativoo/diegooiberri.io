...
const data = {
  ...
  nickname: "creaticode",
  description:
    "¡Hola👋! Soy un Desarrollador FullStack 👨‍💻 ubicado en México, con superpoderes en FontEnd & BackEnd, mi pasión es optimizar los sitios web para que sean claros, intuitivos, rápidos y accesibles. También puedes encontrarme por acá😁:",
  avatar: "https://i.ibb.co/6HBF8kV/3.png",
  social: [
    {
      name: "platzi",
    ...
    {
      name: "instagram",
      url: "https://www.instagram.com/diegooiberri/",
      color: "#E4405F",
      viewBox: "0 0 24 24",
    ...
    {
      name: "linkedin",
      url: "https://www.linkedin.com/in/creativoo/",
      color: "#4361ee",
      viewBox: "0 0 448 512",
      username: "creativoo",
    ...
    {
      name: "twitter",
      url: "https://www.twitter.com/diegooiberri",
      color: "#1984b2",
      viewBox: "0 0 24 24",
      username: "diegooiberri",
  ...
  footer: "Copyright © 2023 🚀 CreatiCode",
};
...
const main = () => {
  ...
  mainSection.innerHTML = links;
  $links.appendChild(mainSection);
};
